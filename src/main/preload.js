...
contextBridge.exposeInMainWorld('doorayAssistant', {
  ...
  getTaskWorkflows: (projectId) => ipcRenderer.invoke('dooray:get-task-workflows', { projectId }),
  setTaskWorkflow: (projectId, postId, workflowId) => ipcRenderer.invoke('dooray:set-task-workflow', { projectId, postId, workflowId }),
  updateTaskMeta: (projectId, postId, changes) => ipcRenderer.invoke('dooray:update-task-meta', { projectId, postId, changes }),
  getTaskMilestones: (projectId) => ipcRenderer.invoke('dooray:get-task-milestones', { projectId }),
  updateTaskComment: (projectId, postId, logId, content) => ipcRenderer.invoke('dooray:update-task-comment', { projectId, postId, logId, content }),
  deleteTaskComment: (projectId, postId, logId) => ipcRenderer.invoke('dooray:delete-task-comment', { projectId, postId, logId }),
  downloadTaskFile: (projectId, postId, fileId, fileName) => ipcRenderer.invoke('dooray:download-task-file', { projectId, postId, fileId, fileName }),
